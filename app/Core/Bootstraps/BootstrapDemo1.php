    ...
    private static function initToolbar()
    {
        ...
        if ($typeOptions) {
            if (isset($typeOptions['height'])) {
                Theme::addCssVariable('body', '--bs-toolbar-height', $typeOptions['height']);
            }

            if (isset($typeOptions['height-tablet-and-mobile'])) {
                Theme::addCssVariable('body', '--bs-toolbar-height-tablet-and-mobile', $typeOptions['height-tablet-and-mobile']);
            }
        }
    }
