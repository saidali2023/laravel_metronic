...
<div class="card card-flush h-md-100">
	...
	<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%; background-image:url('assets/media/stock/900x600/42.png')">
		...
		<!--begin::Wrapper-->
		<!--begin::Illustration-->
		<img class="mx-auto h-150px h-lg-200px theme-light-show" {{ asset(theme()->getMediaUrlPath() . 'illustrations/misc/upgrade.svg') }} alt="" />
		<img class="mx-auto h-150px h-lg-200px theme-dark-show" {{ asset(theme()->getMediaUrlPath() . 'illustrations/misc/upgrade-dark.svg') }} alt="" />
		<!--end::Illustration-->
	</div>
	<!--end::Body-->
</div>
