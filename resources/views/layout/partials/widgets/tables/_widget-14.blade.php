				...
				<tbody>
						...
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img {{ asset(theme()->getMediaUrlPath() . 'stock/600x600/img-49.jpg') }} class="" alt="" />
								</div>
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img {{ asset(theme()->getMediaUrlPath() . 'stock/600x600/img-40.jpg') }} class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img {{ asset(theme()->getMediaUrlPath() . 'stock/600x600/img-39.jpg') }} class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img {{ asset(theme()->getMediaUrlPath() . 'stock/600x600/img-47.jpg') }} class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
					...
					<tr>
						<td>
							<div class="d-flex align-items-center">
								<div class="symbol symbol-50px me-3">
									<img {{ asset(theme()->getMediaUrlPath() . 'stock/600x600/img-48.jpg') }} class="" alt="" />
								</div>
								<div class="d-flex justify-content-start flex-column">
